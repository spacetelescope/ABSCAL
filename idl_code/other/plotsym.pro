pro plotsym, psym, psize, FILL=fill,thic=thic    ;Define some plotting symbols
;+
; NAME:
;	PLOTSYM
; PURPOSE:
...
;       THIC -  Thickness of unfilled symbols. Default is 1.
;
; OUTPUTS:
;	None
;
...
;	98Aug20		Added keyword thic parameter - RCB.
;-
 On_error,2
 ...
 if not keyword_set(thic) then thic=1
...
8:  begin                                     ;Square
 ...
 usersym, xarr, yarr, FILL = fill,thic=thic
