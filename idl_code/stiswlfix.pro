...
;	02aug27-Use targoffs, instead of correcting toffset w/ same sign conv.
...
; 2019may17 - start policy of incl. all >.1 MAMA & CCD shifts & to .03 precision
...
; 2019aug6 -  GRW Ly-alpha too wide & other G140L lines too weak. Try using only
;	>1px shifts.
;-
offset=0.0
...
; See wlerr.*grat*-wd & from nowavecal.pro:wl.offsets* for agk, grw, etc
root=strupcase(strmid(fulroot,0,9))
	case cenwave of 
...
; See wl.offsets file for (most of) these GRW values: Wide line ~.4px threshold
			'O3YX14HSM': offset= 1.19       ; 19aug GRW+70 G140L
			'O3YX15QEM': offset= 0.95       ; 19aug GRW+70 G140L
			'O3YX16KLM': offset= 0.71       ; 19aug GRW+70 G140L
			'O45910010': offset= 0.50       ; 19aug GRW+70 G140L
			'O45911010': offset= 0.40       ; 19aug GRW+70 G140L
			'O5JJ99010': offset= 0.42       ; 19aug GRW+70 G140L
			'O69S06010': offset=+0.36       ; 19aug GRW+70 G140L
			'O6I812010': offset=-0.45       ; 19aug GRW+70 G140L
			'O8IA01010': offset=-0.43       ; 19aug GRW+70 G140L
; ff flagged BAD in dirlow.full:
			'O8IA03010': offset= 7.97       ; 19aug GRW+70 G140L
; unstble .19-->.43,.33-->.19
			'O8H107010': offset= 0.31	; 19aug LDS749 G140L
			'O8H108010': offset=-0.16	; 19aug LDS749 
; unstble -.28-->-.35-->-.21
			'O8H109010': offset=-0.28	; 19aug LDS749 G140L
			
			'OBN6L2010': offset=-0.42       ; 19aug GRW+70 G140L
			'OC4KL3010': offset=-0.28       ; 19aug GRW+70 G140L
			'OCQJL1040': offset=-0.30       ; 19aug GRW+70 G140L
			'OCQJL2040': offset=-0.39       ; 19aug GRW+70 G140L
			'OCQJL3040': offset=-0.69       ; 19aug GRW+70 G140L
			'OD1CL1040': offset=-0.29       ; 19aug GRW+70 G140L
...
; Bad too noisy		'OBNL04010': offset=1.9 	; 1757132
			...
			'OBBM01010': offset=-0.19       ; 19Jul LDS749 G140L
			...
			'OBNL02010': offset= 0.58 ; 19aug HD3772 unstbl@.48-.67
...
;	w/ 2 HeI line at 2945.96 vac WLs. vs. Model in 09Nov
			...
			'O8H108040': offset= 0.57       ; 19aug LDS749 G230L
			'OBBM01040': offset=+.16 	; 19aug lds749b G230L
...
;			'OBW3L1020': offset=-2.33 ; 12jan10 wl.offsets-2009 grw
		...
		'2375':case root of			;G230LB
			...
			'ODBVL1010': offset=-0.80       ; 19aug AGK+81 G230LBE1
			'ODBVL2010': offset=-0.63       ; 19Jul AGK+81 G230LBE1
...
; 13Mar7-Switch nowavcal to use the 2479.3 line & del the -2.5 shift for 1700A:
		...
		'4300': case root of	; 02dec3 po41wl.g430l-befor from H&K
			...
			'ODDG02010': offset=-0.67       ; 19aug GRW+70 G430LE1
...
; see dir2009.log for new SM4 data:
			...
			'OBAU04040': offset=-0.51       ; 19aug AGK+81 G430LE1
			...
			'OD1AL2040': offset=-1.18       ; 19aug AGK+81 G430LE1
			...
			'ODBVL2040': offset=-0.83       ; 19aug AGK+81 G430LE1
...
; unstable -0.22-->-.09, 0-->-.36
			'O8H106020': offset=-0.22       ; 19aug WD1026
			...
			'O8H108030': offset=-1.35       ; 19Jul LDS749 G430LE1
...
; ck w/ line used by LDS749B: (4472.755-4485.9)/2.73=-4.8 --> adopt -4.6
		...
		'7751': case root of			;h-alpha=6563
			...
			'O8U203060': offset=-0.32       ; 19aug AGK+81 G750L
...
; WD offsets in wlerr.g750l-wd. For prime WD:
			...
			'ODUD02060': offset=+0.34       ; 19aug GD153
...
;	HAS wavecal...
;info only		'OC3I13030': offset=-0.38       ; 19aug GJ7541 G750L
...
if cenwave gt '4300' and cenwave ne '7751' then begin	; 2019aug-added ticks
	case root of
